...
% TODO: could mention other applications
...
\begin{frame}{Inverse Reinforcement Learning (COLT 1998)}
  ...
  \end{definition}
  \pause
  \begin{definition}[Inverse Reinforcement Learning Problem]
    Given:
    \begin{itemize}
...
\begin{frame}{Maximum Causal Entropy}
  \begin{minipage}[t]{\textwidth}
    \begin{block}{Standard MDP}
      ...
      \]
    \end{block}
    \begin{block}{Maximum Causal Entropy MDP\footfullcite{DBLP:conf/icml/ZiebartBD10}}
      \[
