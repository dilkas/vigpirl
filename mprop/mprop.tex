...
\begin{equation} \label{eq:elbo}
  ...
  \end{split}
\end{equation}
% TODO: are they actually Lebesgue? What about notation?
...
\subsection{Structure of the Approximating Distribution}
...
We can use the same idea on parts of $\mathcal{L}$ that we cannot take the
derivative of otherwise. In this case, we want a gradient instead of a limit,
and the integral represents an expected value.
...
benchmark as well \cite{wulfmeier2015maximum,DBLP:conf/uai/JinDAS17}, our
