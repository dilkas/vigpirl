...
\begin{align}
  ...
  \end{align} % TODO: introduce m here, deleting later introduction
...
\begin{table}
  \centering % TODO: recheck and explain
  \begin{tabular}{llllll} % Lower bound? Model? % TODO: comment about 'modelled' no longer needed
    \toprule
...
methods. % TODO: not full (I think) + discuss the possibility of making it
         % variational
...
\begin{proof} % TODO: cite the matrix cookbook
