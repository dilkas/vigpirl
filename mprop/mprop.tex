...
\newcommand{\da}{\frac{\partial}{\partial\alpha}}
\newcommand{\db}{\frac{\partial}{\partial\beta}}
...
% TODO: uncorrelated gammas instead of a multivariate Gaussian? review several options
...
\begin{split} % TODO: dominated convergence theorem
