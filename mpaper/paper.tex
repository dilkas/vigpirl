...
complicated ways
\cite{DBLP:conf/icml/PieterN04,DBLP:journals/corr/abs-1806-06877}. Moreover,
...
features
\cite{DBLP:conf/icml/PieterN04,DBLP:conf/uai/NeuS07,DBLP:conf/icml/NgR00,ziebart2008maximum}.
...
% TODO: rewrite and make this section smaller

% apprenticeship learning, imitation learning
%a problem proposed by Russell in 1998 \cite{DBLP:conf/colt/Russell98}
...
% How much does a reward have to change to change the policy? Could be an
% interesting use case for variance predictions.
