...
Note that in this paper all integrals should be interpreted as definite
integrals over the entire sample space. Also, all expected values are with
respect to $\approximation$.
...
% TODO: matrix notation should be at the start of The Problem
