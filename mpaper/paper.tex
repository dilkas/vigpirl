...
% TODO: need to add a literature survey here
...
How well does the variance prediction work? It doesn't, but why?
TODO: Sage should consider 3x3 matrices
TODO: 4 plots---two my MATLAB, two my Sage; two for B[1, 1], two for B[2, 1].
The MATLAB plots show E[v] and dE[v]/dB, the Sage plots show q(u) and
dq(u)/dB. Function in blue, derivative in red, over a range of values.
