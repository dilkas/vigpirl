...
\begin{figure*}
  ...
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\columnwidth]{figures/convergence1}
  \end{minipage}%
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\columnwidth]{figures/convergence2}
  \end{minipage}
...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/parameter_convergence1}
...
%The experiments were run with a constant step size of 0.1, discarding iterations where either $\bm\Sigma$ or $\bm\Gamma$ becomes near-singular.
